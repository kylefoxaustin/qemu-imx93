...
static void lpspi_update_irq(IMX93LpspiState *s)
{
...
static void lpspi_transfer(IMX93LpspiState *s, uint32_t tx)
{
...
static const VMStateDescription vmstate_lpspi = {
    .name = TYPE_IMX93_LPSPI,
    .version_id = 1,
    .minimum_version_id = 1,
    .fields = (const VMStateField[]) {
        VMSTATE_UINT32(cr, IMX93LpspiState),
        VMSTATE_UINT32(sr, IMX93LpspiState),
        VMSTATE_UINT32(ier, IMX93LpspiState),
        VMSTATE_UINT32(cfgr1, IMX93LpspiState),
        VMSTATE_UINT32(tcr, IMX93LpspiState),
        VMSTATE_FIFO32(rx, IMX93LpspiState),
        VMSTATE_END_OF_LIST()
    },
};
...
static const TypeInfo lpspi_types[] = {
    {
        ...
        .instance_size = sizeof(IMX93LpspiState),
