 ...
 * by the i.MX 93 SoC for the i.MX SiP RPROC and SOC-info calls). Returns true
 * if it handled the call, writing up to four SMC return values to ret[0..3]
 * (mapped to x0..x3 / r0..r3).
 */
