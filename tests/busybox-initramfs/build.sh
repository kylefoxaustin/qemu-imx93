...
# imx93 machine (validation Tier 1.3). No cross-compiler needed: it fetches
...
# Then:   INITRD=$(pwd)/busybox-initramfs.cpio.gz ../weston/run.sh
set -eu
